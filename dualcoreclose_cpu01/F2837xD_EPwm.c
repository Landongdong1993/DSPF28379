...
void InitEPwm11Gpio(void)
{
    ...
    // Comment out other unwanted lines.
    //
    GpioCtrlRegs.GPAPUD.bit.GPIO20 = 1;   // Configure GPIO163 as EPWM10A
    GpioCtrlRegs.GPAPUD.bit.GPIO21 = 1;   // Configure GPIO164 as EPWM10B
    ...
    // Comment out other unwanted lines.
    //
    GpioCtrlRegs.GPAGMUX2.bit.GPIO20 = 1;   // Configure GPIO163 as EPWM10A
    GpioCtrlRegs.GPAGMUX2.bit.GPIO21 = 1;   // Configure GPIO164 as EPWM10B
    GpioCtrlRegs.GPAMUX2.bit.GPIO20 = 1;   // Configure GPIO163 as EPWM10A
    GpioCtrlRegs.GPAMUX2.bit.GPIO21 = 1;   // Configure GPIO164 as EPWM10B
